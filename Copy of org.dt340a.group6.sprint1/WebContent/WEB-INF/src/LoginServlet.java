...
public class LoginServlet extends HttpServlet {
	...
	//	String loginQueryString = "select distinct e.model, c.cause_eventId, c.cause_causeCode, count(*) from equipment e, callfailure c where c.equipment_tac=e.tAC and e.model='vea3' group by c.cause_eventId, c.cause_causeCode;";
...
//			System.out.print("=-------------------------Query Result ---------" + loginResultSet.getString(1));
...
//			RequestDispatcher dispatcher=context.getRequestDispatcher("/success");
