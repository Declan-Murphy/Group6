...
insert into compact_discs values(18,'Massive Attack',12.99,'Mezzanine');
insert into compact_discs values(16,'Spice Girls',4.99,'Spice World');




insert into tracks values (1, 'Naff Track',16);
insert into tracks values (2, 'Naffer Track',16);
insert into tracks values (3, 'Naffest Track',16);


insert into tracks values (4, 'Cool Track',18);
insert into tracks values (5, 'Cooler Track',18);
